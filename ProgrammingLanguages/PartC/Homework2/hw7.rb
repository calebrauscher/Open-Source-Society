...
class Point < GeometryValue
  ...
  def inbetween(v, end1, end2)
    ...
    (end1 - epsilon <= v && v <= end2 + epsilon) or (end2 - epsilon <= v && end2 + epsilon)
  end
end
...
class LineSegment < GeometryValue
  ...
  def intersectWithSegmentAsLineResult(seg)
    ...
    if real_close(x1, x2)
        ...
        x2Start, y2Start, x2End, y2End = y1 < seg.y1 ? seg1 + seg2 : seg2 + seg1
        ...
        x1Start, y1Start, x1End, y1End,
        x2Start, y2Start, x2End, y2End = x1 < seg.x1 ? seg1 + seg2 : seg2 + seg1
